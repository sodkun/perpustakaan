...
<head>
 ...
 <div class= "tabel">
    ...
    <form action="tambah_anggota.php" method="post" name="form1">
        <table width="50%" border="0">
            ...
            <tr> 
                ...
                <td>
                    ...
                    <option disabled selected>Status Anggota</option>
    ...
    if(isset($_POST['Submit'])) {
        ...
        $result = mysqli_query($mysqli, "INSERT INTO anggota(nama_anggota,jenis_kelamin,status,alamat_anggota,telp_anggota) VALUES('$nama','$jekel','$status','$alamat','$telp')");
        
        // Show message when user added
        echo "Sukses Menambah Anggota. <a href='anggota.php'>Lihat Anggota</a>";
    }
    ?>
</div>
</body>

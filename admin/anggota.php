...
<ul class="sidebar">
  ...
  <a href="tambah_anggota.php">Tambah Anggota</a><br/><br/>
    ...
    <tr>
        <th>Nama</th> <th>Jenis Kelamin</th> <th>Status</th> <th>Alamat</th> <th>Telepon</th><th>Aksi</th>
    </tr>
    <?php
    ...
    while($tampil = mysqli_fetch_array($data)) {         
        ...
        echo "<td>".$tampil['alamat_anggota']."</td>";
        echo "<td>".$tampil['telp_anggota']."</td>";         
        echo "<td><a href='edit_anggota.php?id=$tampil[id_anggota]'>Edit</a> | <a href='delete_anggota.php?id=$tampil[id_anggota]'>Delete</a></td></tr>";        
    }
    ?>
    </table>
</div>

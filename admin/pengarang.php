...
<ul class="sidebar">
  ...
  <div class= "tabel">
  <a href="tambah_pengarang.php">Tambah Pengarang</a><br/><br/>
    ...
    while($tampil = mysqli_fetch_array($data)) {         
        ...
        echo "<td>".$tampil['alamat_pengarang']."</td>";
        echo "<td>".$tampil['telp_pengarang']."</td>";         
        echo "<td><a href='edit_pengarang.php?id=$tampil[id_pengarang]'>Edit</a> | <a href='delete_pengarang.php?id=$tampil[id_pengarang]'>Delete</a></td></tr>";        
    }
    ?>
    </table>
</div>
